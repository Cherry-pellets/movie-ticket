...
<script>
    import {getCurrentPageMovieSchedule,getOptions2,getHallByCinemaId,addScheduleInfo,deleteMovieSchedule} from '@/api/movie'
    ...
    export default {
        ...
        methods: {
          async loadCurrentPageMovieSchedule(currentPage,pageSize,input){
            let {data, status} = await getCurrentPageMovieSchedule({
              pageNum: currentPage,
              limit:pageSize,
              keyword:input
            });
          ...
          async addSchedule(){
            ...
            if (status === 200 && data.state===200){
              ...
              this.cinemaOptions = data.data.cinemas;
            }
