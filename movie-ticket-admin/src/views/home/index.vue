  ...
  methods: {
    async loadAdminInfo() {
      if (localStorage.getItem("name")) {
        //let json = await getAdminInfo(localStorage.getItem("admin_id"));
        //if (json.state === 200) {
          this.adminInfo.name = localStorage.getItem("name");
          this.adminInfo.avatar = localStorage.getItem("avatar");
